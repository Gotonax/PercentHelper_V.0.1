...
class Myscr1(MDScreen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self._md_bg_color = '#B5B8B1'
class Mybutton(MDRectangleFlatButton):
    ...
    def __init__(self, **kwargs):
        ...
        self.text_color="#354A00"
        self.line_color="#354A00"
...
class MyApp(MDApp):
    ...
    def build(self):
        ...
        MainScr= Myscr1(name='Main Screen')


        #img = Image(source='icon.png', size_hint=(1, .5), pos_hint={'center_x': .5, 'center_y': .5})
        scr1 = Myscr1(name='First MDScreen')
        scr2 = Myscr1(name='Second MDScreen')
        scr3 = Myscr1(name='Third MDScreen')
        scr4 = Myscr1(name='Fourth MDScreen')
        scr5 = Myscr1(name='Fifth MDScreen')
        scr6 = Myscr1(name='Sixth MDScreen')
        scr7 = Myscr1(name='Seventh MDScreen')
        scr8 = Myscr1(name='Eighth MDScreen')
        scr9 = Myscr1(name='Ninth MDScreen')
        scr10 = Myscr1(name='Tenth MDScreen')
        scrStory = Myscr1(name='Story')
        FeedBackScr = Myscr1(name='Feedback')
        ...
        #FIV = FitImage(source="icon.png", pos_hint={"top": 1})
        mainlb=Mylabel(text='Percent helper')
        fontbut = MDRectangleFlatButton(text='Поменять шрифт', pos_hint= {"center_x": .5, "center_y": .5}, font_size = '16sp', size_hint= (.5, 0.1), text_color="#354A00", line_color="#354A00")
        fontbut.bind(on_release=self.changefont)

        mainbut1=Mybutton(text='Найти процент от числа')
        mainbut1.bind(on_release=self.toset1)
        mainbut2 = Mybutton(text='Сколько процентов составляет число от числа')
        mainbut2.bind(on_release=self.toset2)
        mainbut3 = Mybutton(text='Увеличить число на процент')
        mainbut3.bind(on_release=self.toset3)
        mainbut4 = Mybutton(text='Уменьшить число на процент')
        mainbut4.bind(on_release=self.toset4)
        mainbut5 = Mybutton(text='Каждый третий, каждый пятый, что это?')
        mainbut5.bind(on_release=self.toset5)
        mainbut6 = Mybutton(text='Часть от числа, это сколько? \n(вторая часть, третья, четверть)')
        mainbut6.bind(on_release=self.toset6)
        mainbut7 = Mybutton(text='Дробь от числа (умножение дроби на число)')
        mainbut7.bind(on_release=self.toset7)
        mainbut8 = Mybutton(text='Деление числа на дробь')
        mainbut8.bind(on_release=self.toset8)
        mainbut9 = Mybutton(text='НДС (Ищем число зная сумму с НДС)')
        mainbut9.bind(on_release=self.toset9)
        mainbut10 = Mybutton(text='Возведение числа в степень')
        mainbut10.bind(on_release=self.toset10)
        mainbutStory = Mybutton(text='История запросов (результаты)')
        mainbutStory.bind(on_release=self.tosetStory)
        mainbutFB = Mybutton(text='Обратная связь')
        mainbutFB.bind(on_release=self.tosetFB)

        #blMS.add_widget(FIV)
        blMS.add_widget(mainlb)
        blMS.add_widget(fontbut)
        ...
        scr1but1 = Mybutton(text='Рассчитать')
        scr1but1.bind(on_press=self.scr1count)
        self.scr1rez =Mylabel(text="Результат: ")
        ...
        self.scr2rez =Mylabel(text="Результат: ")
        scr2but1 =Mybutton(text='Рассчитать')
        ...
        scr3but =Mybutton(text='Возврат в меню')  # Меню экрана 3 - Увеличить число на процент
        ...
        scr3but1 =Mybutton(text='Рассчитать')
        ...
        scr4but =Mybutton(text='Возврат в меню')  # Меню экрана 4 - Увеличить число на процент
        ...
        scr4but1 =Mybutton(text='Рассчитать')
        ...
        scr5but =Mybutton(text='Возврат в меню')  # Меню экрана 5 – Каждый 3 каждый 5
        ...
        scr5but1 =Mybutton(text='Рассчитать')
        ...
        scr6but =Mybutton(text='Возврат в меню')  # Меню экрана 6 – Часть от числа (пятая, треть, четверть)
        ...
        scr6but1 =Mybutton(text='Рассчитать')
        ...
        scr7but =Mybutton(text='Возврат в меню')  # Меню экрана 7 – Дробь от числа (умножение)
        ...
        scr7but1 =Mybutton(text='Рассчитать')
        ...
        scr8but =Mybutton(text='Возврат в меню')  # Меню экрана 8 – Дробь от числа (Деление)
        ...
        scr8but1 =Mybutton(text='Рассчитать')
        ...
        scr9but =Mybutton(text='Возврат в меню')  # Меню экрана 9 – Дробь от числа (Деление)
        ...
        scr9but1 =Mybutton(text='Рассчитать', size_hint=(1, .2), text_color="#354A00", line_color="#354A00")
        ...
        scr10but =Mybutton(text='Возврат в меню', size_hint=(1, .2), text_color="#354A00", line_color="#354A00")  # Меню экрана 10 – Степень числа
        ...
        scr10but1 =Mybutton(text='Рассчитать', size_hint=(1, .2), text_color="#354A00", line_color="#354A00")
        ...
        scrStorybut =Mybutton(text='Возврат в меню', size_hint=(1, 0.05), text_color="#354A00", line_color="#354A00")  # Меню экрана 11 – Список результатов
        scrollStory = MDScrollView()
        scrStorybut.bind(on_release=self.tomain)
        scrStorylb =MDLabel(
            text="Список ранее проведённых Вами операций.\n (Только 5000 символов).\nЕсли хотите очистить историю,\n нажмите Очистить.",
            halign='center', size_hint=(1, 0.1), underline=True, theme_text_color= "Custom", text_color="#354A00")
        scrStorybut1 =Mybutton(text='Очистить', size_hint=(1, 0.05), text_color="#354A00", line_color="#354A00")
        scrStorybut1.bind(on_press=self.scrStorycount)
        self.scrStoryrez =MDLabel(text="История:\n", halign='center',valign='top', size_hint=(1, 0.5))
        scrStorybut2 = Mybutton(text='Скачать историю. \nПри нажатии на эту кнопку, история операций \nбудет сохранена в вашем телефоне в папке \nDownload(загрузки) в виде файла history.txt', size_hint=(1, 0.05), text_color="#354A00", line_color="#354A00")
        scrStorybut2.bind(on_press=self.scrStorydownload)
    ...
    def changefont(self, instance):

        # if self.fontbut.text==str('Поменять шрифт'):

        self.ids.mybutton.self.font_size = '25sp'
    ...
    def tomain(self, instance):
        if self.sm.current=='First MDScreen':
            ...
            self.scr10inp1.text = ''
            self.scr10inp2.text = ''
        if len(self.scrStoryrez.text)>5000:
    ...
    def scrStorydownload(self, instance):
        f = open("//storage//emulated//0//Download//history.txt", "w")
        f.write(str(self.scrStoryrez.text))
        f.close()
